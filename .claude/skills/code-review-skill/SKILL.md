...
> Note: This copy has been trimmed to the languages used in this repository
> (a client-only React + TypeScript + Vite SPA). Guides for other languages
> were removed; see the upstream repo if you need them.
